...
) ENGINE = InnoDB AUTO_INCREMENT = 4123 DEFAULT CHARSET = utf8mb4;
...
VALUES
  (8, 'IMPUESTO VENTA', '2', NULL, NULL, NULL);
...
VALUES
  (6, 'Color favorito?', NULL, NULL, NULL, NULL, 1);
INSERT INTO
  `tbl_preguntas` (
    `COD_PREGUNTA`,
    `PREGUNTA`,
...
VALUES
  (7, 'Animal?', NULL, NULL, NULL, NULL, 1);
